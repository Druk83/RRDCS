...
- **scope_in:**
  ...
  - Консолидация evidence с привязкой к `repository_slug` и `profile_version` для multi-repo rollout.
- **scope_out:**
...
5. Позволяет сравнивать качество и стабильность между подключенными репозиториями.
