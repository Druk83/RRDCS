...
### 2.1 Actors
- **Система непрерывной интеграции (Continuous Integration System):** публикует summary и artifacts.
- **Разработчик (Developer):** анализирует причины падений.
- **Технический лидер и архитектор (Tech Lead and Architect):** использует отчеты для приемки.
...
**Постусловия:** сформирован `RunSummary`, связаны `EvidenceLink`, обновлен `VerificationReport`.

### 5.1 Lanes
- **ACTOR:** Система непрерывной интеграции (Continuous Integration System), Разработчик (Developer), Технический лидер и архитектор (Tech Lead and Architect)
...
8. BC Отчетность и доказательная база (Reporting and Evidence BC) -> **(EVT) PRSummaryPublished** -> Разработчик (Developer).
9. BC Отчетность и доказательная база (Reporting and Evidence BC) -> **(CMD) UpdateVerificationReport** -> Технический лидер и архитектор (Tech Lead and Architect).
...
| AGG-RE-002 | Verification Reporting | VerificationReport | RunSummary | UC-RE-01, CMD UpdateVerificationReport | BR-RE-03 |
...
![Диаграмма последовательности: UC-01 Публикация сводки PR и доказательной базы (Publish PR Summary and Evidence)](diagrams/UC-01-sequence.png)
